...
namespace Rutatiina\GoodsIssued\Traits;
...
trait Validate
{
    ...
    private function validate()
    {
        ...
        $this->settings = GoodsIssuedSetting::with(['financial_account_to_debit', 'financial_account_to_credit'])->first();
        ...
        $last_txn = GoodsIssued::latest()->first();
