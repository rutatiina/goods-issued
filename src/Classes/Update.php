...
use Rutatiina\GoodsIssued\Traits\InventoryReverse as TxnTraitsInventoryReverse;
...
class Update
{
    ...
    public function run()
    {
        ...
        $Txn = GoodsIssued::with('items', 'ledgers', 'debit_account', 'credit_account')->find($this->txn['id']);
        ...
        try
        {
            ...
            {
                $ledger['goods_issued_id'] = $txnId;
                GoodsIssuedLedger::create($ledger);
            }
            unset($ledger);
