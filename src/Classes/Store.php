...
use Rutatiina\GoodsIssued\Traits\TxnItemsJournalLedgers as TxnTraitsTxnItemsJournalLedgers;
...
class Store
{
    ...
    public function run()
    {
        ...
        try
        {
            ...
            {
                unset($item['taxes']);
                $item['goods_issued_id'] = $this->txn['id'];
            ...
            {
                $ledger['goods_issued_id'] = $this->txn['id'];
